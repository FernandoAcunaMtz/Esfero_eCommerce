...
<nav class="navbar" id="navbar">
    <div class="nav-container">
        ...
        <div class="navbar-brand">
            <a href="index.php" class="logo">Esfero</a>
        </div>
        ...
        <div class="navbar-user">
            <?php if ($is_logged_in): ?>
                ...
                <?php elseif ($is_logged_in && !is_admin()): ?>
                    <a href="activar_vendedor.php" class="btn-vender" title="Activa tu cuenta de vendedor">Vender</a>
                <?php endif; ?>
            <?php else: ?>
        ...
        <div class="mobile-menu-user">
            <?php if ($is_logged_in): ?>
                <div style="padding: 1rem 1.5rem; border-top: 1px solid #eee;">
                    ...
                    <?php elseif (!is_admin()): ?>
                    <a href="activar_vendedor.php" class="btn-register" style="display: block; text-align: center; margin-bottom: 0.5rem;" onclick="closeMobileMenu()">Vender</a>
                    <?php endif; ?>
